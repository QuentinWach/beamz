...
def demo_scene() -> SceneSpec:
    objects = [
        ...
        Object3D(
            kind="plane",
            label="Mode Source",
            geometry={"center": [1.2, 3.0, 0.33], "size": [1.2, 0.8], "normal": [1.0, 0.0, 0.0]},
        ...
        Object3D(
            ...
            geometry={"origin": [1.2, 3.0, 0.33], "direction": [1.0, 0.0, 0.0], "length": 1.3},
        ...
        Object3D(
            kind="plane",
            label="Flux Monitor",
            geometry={"center": [8.4, 3.0, 0.33], "size": [1.4, 1.2], "normal": [1.0, 0.0, 0.0]},
    ...
    return SceneSpec(
        title="ZView Demo Scene",
        units="um",
        background="#f8fafc",
        camera=CameraSpec(position=(11.0, -3.5, 5.5), target=(5.0, 3.0, 0.33), fov=36.0),
        clip_planes=[
