...
class Fields:
    ...
    def set_pml_conductivity(self, pml_data):
        ...
        self.pml_data = {k: jnp.asarray(v) if hasattr(v, '__array__') else v
    ...
    def _init_material_parameters_3d(self):
        ...
        if self.has_pml and hasattr(self, 'pml_data'):
            ...
            if 'sigma_x' in self.pml_data: sigma_pml = sigma_pml + self.pml_data['sigma_x']
            if 'sigma_y' in self.pml_data: sigma_pml = sigma_pml + self.pml_data['sigma_y']
            if 'sigma_z' in self.pml_data: sigma_pml = sigma_pml + self.pml_data['sigma_z']
